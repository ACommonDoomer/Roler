...
console.log("Esta es una Alpha <3, disfruta de Roler");
...
client.on("ready", () => {
  console.log("Rolerbot está listo para ser usado");
  client.user.setPresence({
    status: "online",
    game: {
      name: "rl!help, Alpha 1.0.4 (Christmas Update)",
      type: "WATCHING"
    }
  });
});
...
client.on("message", async msg => {
  ...
  if (cmd === "help2") {
    ...
    .addField("Christmas Update", "Alpha 1.0.4")
