...
client.on("message", async msg => {
  ...
  if (cmd === "help3") {
    ...
    .addField("Versión actual del bot:", "Alpha 1.0.6")
    .addField("Repositorio:", "https://github.com/BloxOfficial/roler")
    .addField("Old Update", "Alpha 1.0.6")
    ...
    .addField("New Update", "Alpha 1.0.7")
    .addField("rl!searchaflv+ [Busqueda]", "(Se hará una busqueda en AnimeFLV sobre lo que haya ingresado despues del comando, Roler pondra el enlace en el embed")
    .addField("rl!searchwiki + [Busqueda]", "Se hará una busqueda en Wikipedia sobre lo que haya ingresado despues del comando, Roler pondra el enlace en el embed")
    .addField("rl!ide", "Se despliega una pequeña lista con los editores de código más usados en el ambito del desarrollo")
    .addField("rl!hola + [Mencionado]", "Se manda un gif (De anime :3) de un personaje diciendole hola a el usuario mencionado :heart:")
    .addField("rl!piedra, papel, tijeras", "Inicia una ronda de piedra, papel y tijeras contra Roler, suerte, es dificil de vencer...")
    .setFooter("Página 3 of 3")
    msg.channel.send(embed);
    }
...
let arg = parseInt(args.join(" "));
 ...
 if(cmd == "triggered") {
  ...
  if (cmd == "dnatest") {
   ...
   const embed = new Discord.RichEmbed();
          embed.setTitle(`Verdadero o falso`)
  ...
  //Old Update (Alpha 1.0.7)
  
  if(cmd === "searchaflv") {
    let searchQTitleAFLV = args.join(" ")
    let searchAFLVQ = args.join("+");
    let searchAFLVE = ('browse?q=' + searchAFLVQ);
    if(!searchAFLVQ) return msg.channel.send('¿Que querías buscar?');
    const embed = new Discord.RichEmbed()
    .setThumbnail("https://animeflv.net/assets/animeflv/img/logo.png?v=2.3")
    .setDescription(`Busqueda realizada por **${msg.author.username}**`)
    .setTitle('(En AnimeFLV) Buscaste ' + searchQTitleAFLV)
    .addField("https://animeflv.net/" + searchAFLVE, "Cliquea la página para ver su contenido")
    .setColor("#B3B3B3");
    msg.channel.send(embed);
  }
  ...
  if(cmd === "searchwiki") {
    let searchQTitleGH = args.join(" ")
    let searchGHQ = args.join("+");
    let searchGHE = ('wiki/' + searchGHQ);
    if(!searchGHQ) return msg.channel.send('Que querías buscar?');
    const embed = new Discord.RichEmbed()
    .setThumbnail("https://cdn.discordapp.com/attachments/657021119089475623/658864054810574849/Weekie.png")
    .setDescription(`Busqueda realizada por **${msg.author.username}**`)
    .setTitle('(En Wikipedia <3) Buscaste ' + searchQTitleGH)
    .addField("https://es.wikipedia.org/" + searchGHE, "Da click al enlace para ver el contenido de la página")
    .setColor("#B3B3B3");
    msg.channel.send(embed);
  }
  ...
  if (cmd === "ide") {
    const embed = new Discord.RichEmbed()
    .setTitle('Editores de código')
    .setDescription('Eh aquí varios editores de código')
    .setColor("#B3B3B3")
    .setThumbnail("https://cdn.glitch.com/f92fb68f-10b7-47b3-9226-c7788bafbf85%2Fides.png?v=1580425139246")
    .addField("SublimeText3:", "Un editor de código demasiado ligero, rápido y con soporte muy completo para muchos lenguajes, aparte de un gran repertorio de Plugins, Descarga: https://www.sublimetext.com/")
    .addField("Visual Studio Code", "Un editor de código muy completo con soporte de Git integrado, Descarga: https://code.visualstudio.com/")
    .addField("Atom", "Un editor de código completo desarrollador por el grupo crador de Github, Descarga: https://atom.io/")
    msg.channel.send(embed);
  }
 ...
 if(cmd == "papel") {
     ...
     const embed = new Discord.RichEmbed();
          ...
          switch(randomR) {
            case 1: embed.addField("Tijeras:", "Gane") ; break;
                 case 2: embed.addField("Piedra", "Perdí") ; break;
     ...
     const embed = new Discord.RichEmbed();
          ...
          switch(randomR) {
            case 1: embed.addField("Tijeras:", "Empate") ; break;
                 ...
                 case 3: embed.addField("Papel:", "Perdí") ; break;            
          };
          msg.channel.send(embed);
        }
    ...
    if(cmd == "piedra") {
     ...
     const embed = new Discord.RichEmbed();
          ...
          embed.setColor("#B3B3B3")
          switch(randomR) {
            case 1: embed.addField("Tijeras:", "Perdí") ; break;
